        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            ...
            <div className="xl:col-span-3">
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 overflow-hidden shadow-2xl h-[700px] lg:h-[830px] flex flex-col">
                <div className="px-6 py-4 bg-gradient-to-r from-ecuador-500 to-ecuador-600 border-b border-white/20">
                  ...
                  <p className="text-ecuador-100 text-sm mt-1">
                ...
                <div className="flex-1 w-full relative">
                  ...
                  {Object.keys(heatData).length === 0 && (
                    <div className="absolute inset-0 flex items-center justify-center bg-black/20 backdrop-blur-sm z-[999]">
                      <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl text-center shadow-2xl">
